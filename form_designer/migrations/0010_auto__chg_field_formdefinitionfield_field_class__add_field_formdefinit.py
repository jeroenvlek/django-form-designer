...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FormDefinition.mail_replyto'
        db.add_column(u'form_designer_formdefinition', 'mail_replyto',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'FormDefinition.mail_replyto'
        db.delete_column(u'form_designer_formdefinition', 'mail_replyto')
    ...
    models = {
        ...
        u'form_designer.formdefinition': {
            ...
            'mail_replyto': ('form_designer.fields.TemplateCharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
